...
mod tests {
    ...
    fn test_vm(input: &str, output: Value) {
    ...
    #[test]
    fn math_stuff() {
        test_vm("1 + 2", Value::Integer(3));
        test_vm("1 * 2", Value::Integer(2));
        test_vm("1 - 2", Value::Integer(-1));
        //test_vm("10 / 2", Value::Float(5.0));
    ...
    //     test_vm(
    //         r#"geq: = {x: y: ~ if or(gtr(x: y) equ(x: y)) {true} {false};}; geq(1 0)"#,
    //         "true",
    //     );
    //     test_vm(
    //         r#"geq: = {x: y: ~ if or(gtr(x: y) equ(x: y)) {true} {false};}; geq(1 1)"#,
    //         "true",
    //     );
    //     test_vm(
    //         r#"geq: = {x: y: ~ if or(gtr(x: y) equ(x: y)) {true} {false};}; geq(1 2)"#,
    //         "false",
    //     );

    //     test_vm(
    //         r#"leq: = {x: y: ~ if or(lss(x: y) equ(x: y)) {true} {false};}; leq(1 0)"#,
    //         "false",
    //     );
    //     test_vm(
    //         r#"leq: = {x: y: ~ if or(lss(x: y) equ(x: y)) {true} {false};}; leq(1 1)"#,
    //         "true",
    //     );
    //     test_vm(
    //         r#"leq: = {x: y: ~ if or(lss(x: y) equ(x: y)) {true} {false};}; leq(1 2)"#,
    //         "true",
    //     );
    //     test_vm(
    //         r#"leq: = {x: y: ~ if or(lss(x: y) equ(x: y)) {true} {false};}; leq(2 3)"#,
    //         "true",
    //     );

    //     test_vm(
    //         r#"abs: = {x: ~ if lss(x: 0) {neg(x)} {x};}; abs(neg(10))"#,
    //         "10",
    //     );
